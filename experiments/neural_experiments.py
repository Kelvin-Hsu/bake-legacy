...
from cake import NeuralEmbeddingClassifier


def run_experiment(x_train, y_train, x_test, y_test,
                   name='neural_experiment',
    ...
    kec = NeuralEmbeddingClassifier(n_dim=n_dim, n_class=n_class, learning_objective=learning_objective, learning_rate=learning_rate, hidden_units=hidden_units)
    kec.log_test_data(x_test, y_test)
    kec.log_directory(full_directory)
    kec.initialise_parameters(zeta=zeta_init, weights_std=weights_std, biases=biases, seed=seed)
    try:
    ...
    config_keys = ['n_train', 'n_test', 'n_dim', 'n_class', 'classes', 'name', 'now_string', 'learning_objective', 'learning_rate', 'hidden_units', 'weights_std', 'biases', 'seed', 'zeta_init', 'max_iter', 'n_sgd_batch', 'sequential_batch', 'save_step', 'log_all', 'full_directory']
    ...
    result_keys = ['step', 'weights', 'bias', 'zeta', 'complexity', 'grad_norms',
